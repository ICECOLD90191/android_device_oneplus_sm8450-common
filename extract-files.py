...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/lib64/vendor.qti.hardware.display.config-V5-ndk_platform.so', 'vendor/lib64/vendor.qti.hardware.qxr-V1-ndk_platform.so', 'vendor/bin/hw/vendor.qti.hardware.display.composer-service'): blob_fixup()
        .replace_needed('android.hardware.common-V2-ndk_platform.so', 'android.hardware.common-V2-ndk.so'),
    'vendor/lib64/android.hardware.biometrics.fingerprint-V1-ndk_platform.so': blob_fixup()
    ...
    ('vendor/lib64/hw/android.hardware.gnss-aidl-impl-qti.so', 'vendor/bin/hw/android.hardware.gnss-aidl-service-qti'): blob_fixup()
        .replace_needed('android.hardware.gnss-V1-ndk_platform.so', 'android.hardware.gnss-V1-ndk.so'),
